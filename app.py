...
st.set_page_config(page_title="💊 svAIsthi", page_icon="https://github.com/Masterhazi/svAIsthi/blob/main/health-8.svg")
...
if submit and imaged:
    with st.spinner("Generating your guide..."):
        try:
            ...
            # Try extracting a YouTube link directly from the response
            ...
            if youtube_video_url:
                ...
                # If no YouTube link is found, extract device title and search on YouTube
